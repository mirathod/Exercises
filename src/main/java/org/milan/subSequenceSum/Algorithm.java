package org.milan.subSequenceSum;
...
public class Algorithm {
	public static void main(String[] args) {
		...
		long sum1 =new Algorithm().MaxSubSequenceSum1(a, a.length);
		long sum2 =new Algorithm().MaxSubSequenceSum2(a, a.length);
		long sum3 =new Algorithm().MaxSubSequenceSum2(a1, a1.length);
		long sum4 =new Algorithm().MaxSubSequenceSum4(a, a.length);
